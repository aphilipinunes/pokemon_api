...
$(document).ready(function(){$.getJSON("https://pokeapi.co/api/v2/pokemon/",function(e){$.each(e.results,function(e,n){var t=e+1;$(".main").append("<a href='#' class='pokemon'><img src=https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/"+t+".png><p>"+n.name+"<p/></a>")})})});