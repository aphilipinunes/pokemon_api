...
function openModal(t,e){$(".loading").fadeIn("fast"),e.preventDefault(),$("#modal .weight span").append(""),$("#modal .height span").append(""),$("#modal .xp span").append(""),$("#modal .type span").append(""),$("#modal .stats span").append(""),$("#modal .habilities span").append(""),$("#modal .selNameAbility").remove();var a=$(t).find("input[type=hidden]").val();$.getJSON(a,function(t){$("#modal h2").text(t.name);var e=t.weight,a=e.toString().substr(0,e.toString().length-1);$("#modal .weight span").html(a+" kg"),$("#modal .height span").html(t.height+" cm"),$("#modal .xp span").html(t.base_experience),$.each(t.types,function(e,a){e===t.types.length-1?$("#modal .type span").html(a.type.name):$("#modal .type span").html(a.type.name+", ")}),$.each(t.stats,function(e,a){e===t.stats.length-1?$("#modal .stats span").html(a.stat.name):$("#modal .stats span").html(a.stat.name+", ")}),$.each(t.abilities,function(t,e){$("#modal .habilities").after("<div class='selNameAbility'>"+e.ability.name+"</div>")}),$("#modal img").attr("alt",t.name),$("#modal img.front").attr("src",t.sprites.front_default),$("#modal img.back").attr("src",t.sprites.back_default),$("#modal").modal({fadeDuration:300}),$(".loading").fadeOut("fast")})}function carregaImagens(t){var e=$(".pokemon").length;if(e<=120){if(null!=t){var a=e+20;if(e>=120)var o="?limit=10&offset=140";else var o="?limit=20&offset="+a;$(".loading").addClass("bottom"),$(".loading").fadeIn("fast")}else{$(".loading").fadeIn("fast");var o=""}$.getJSON("https://pokeapi.co/api/v2/pokemon/"+o,function(t){$.each(t.results,function(t,e){var a=e.url,o=a.replace("https://pokeapi.co/api/v2/pokemon/","https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/"),n=o.slice(0,-1);$(".poke_content").append("<a class='pokemon "+e.name+"' title='Pokemon "+e.name+"' href='#' onclick='openModal($(this), event)'><span class='border'><span class='pokebola'></span><input type='hidden' value='"+e.url+"'><img class='lazy' data-src='"+n+".png' class='"+e.name+"' alt='"+e.name+"'><p>"+e.name+"<p/></span></a>")}),$(".loading").hide(),$(".loading").removeClass("bottom")}).done(function(){$(function(){$(".lazy").lazy({effect:"fadeIn",effectTime:1e3,threshold:0})}),$(window).width()>=1500&&$(".poke_content").height()<=$(window).height()-193&&carregaImagens(o)})}}function lockScroll(){$html=$("html"),$body=$("body");var t=$body.outerWidth(),e=$body.outerHeight(),a=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];$html.data("scroll-position",a),$html.data("previous-overflow",$html.css("overflow")),$html.css("overflow","hidden"),window.scrollTo(a[0],a[1]);var o=$body.outerWidth()-t,n=$body.outerHeight()-e;$body.css({"margin-right":o,"margin-bottom":n})}function unlockScroll(){$html=$("html"),$body=$("body"),$html.css("overflow",$html.data("previous-overflow"));var t=$html.data("scroll-position");window.scrollTo(t[0],t[1]),$body.css({"margin-right":0,"margin-bottom":0})}$(window).scroll(function(){if(/Android|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))window.onscroll=function(){var t,e;t=document.body.scrollHeight,(e=window.scrollY+window.innerHeight)>=t&&carregaImagens(scroll)};else{$(document).height()==$(window).height()+$(window).scrollTop()&&carregaImagens(scroll)}}),$(document).ready(function(){carregaImagens()});